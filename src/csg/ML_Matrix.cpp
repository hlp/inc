...
void DebugOutput(const mlMatrix3x3 & matrix)
{
	//TRACE("[ %12.6f, %12.6f, %12.6f ]\n", matrix.I.x, matrix.J.x, matrix.K.x);
	//TRACE("[ %12.6f, %12.6f, %12.6f ]\n", matrix.I.y, matrix.J.y, matrix.K.y);
	//TRACE("[ %12.6f, %12.6f, %12.6f ]\n", matrix.I.z, matrix.J.z, matrix.K.z);
}

void DebugOutput(const mlMatrix3x4 & matrix)
{
	//TRACE("[ %12.6f, %12.6f, %12.6f, %12.6f ]\n", matrix.I.x, matrix.J.x, matrix.K.x, matrix.T.x);
	//TRACE("[ %12.6f, %12.6f, %12.6f, %12.6f ]\n", matrix.I.y, matrix.J.y, matrix.K.y, matrix.T.y);
	//TRACE("[ %12.6f, %12.6f, %12.6f, %12.6f ]\n", matrix.I.z, matrix.J.z, matrix.K.z, matrix.T.z);
}
